...
define([], function () {
    return {
        ...
        SplashScreen: {
            SplashScreenContent: "<b>Welcome to the Events Calendar</b> <br/> <hr/> <br/> The <b>Events Calendar</b> application can be used by citizens and visitors to discover activities and events occurring in a community. rk or recreation facility and obtain information about recreation activities in their community.  <br/><br/> To locate an event, simply enter an address in the search box, or use your current location. The event(s) will then be highlighted on the map and relevant information about community events presented to the user.  Users can place one or more events on their list and also add the events to their smartphone, tablet or desktop computer calendar.",
            IsVisible: true
        },
        ...
        MapSharingOptions: {
            ...
            FacebookShareURL: "http://www.facebook.com/sharer.php?m2w&u=${0}&t=Events%20Calendar",
            TwitterShareURL: "http://mobile.twitter.com/compose/tweet?status=Events%20Calendar ${0}",
            ShareByMailLink: "mailto:%20?subject=Events%20Calendar&body=${0}"
        },
