...
define([], function () {
    return {
        ...
        //      Hosted Feature Layers publish from an ArcGIS Online organizational account with the Security Setting: “Allow only standard SQL queries” unchecked must use the following expression:
