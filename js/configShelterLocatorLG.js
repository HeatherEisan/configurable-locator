...
define([], function () {
    return {
        ...
        ApplicationName: "Shelter Locator",

        // Set application icon path
        ApplicationIcon: "/js/library/themes/images/ShelterLogo_Blue.png",

        // Set application Favicon path
        ApplicationFavicon: "/js/library/themes/images/favicon.ico",

        // Set URL of help page/portal
        HelpURL: "help_ShelterLocator.htm",
        ...
        SplashScreen: {
            SplashScreenContent: "<center><b>Shelter Locator</b></center><hr></br> The <b>Shelter Locator</b> helps you locate supportive housing or emergency shelters.<br><br> To locate a shelter, simply enter an address or amenity in the search box, or use your current location. The shelter(s) will then be highlighted on the map and relevant information about available amenities presented to the user.",
            IsVisible: true
        },
        ...
        ActivityPanelTitle: "Amenities",

        // Set the Event Panel Title
        EventPanelTitle: "Saved Shelter",
        ...
        MapSharingOptions: {
            ...
            FacebookShareURL: "http://www.facebook.com/sharer.php?m2w&u=${0}&t=Shelter%20Locator",
            TwitterShareURL: "http://mobile.twitter.com/compose/tweet?status=Shelter%20Locator ${0}",
