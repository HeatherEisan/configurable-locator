...
define({
    root: {
        ...
        titles: {
            ...
            directionCurrentLocationText: "My Location", // Setting title for when location is not found while route creation.
        ...
        errorMessages: {
            ...
            falseConfigParams: "Required configuration key values are either null or not exactly matching with layer attributes. This message may appear multiple times.", // Setting error message for configuration key.
            ...
            shareLoadingFailed: "Unable to shorten URL, Bit.ly failed to load.", // Shown when unable to create Bit.ly URL.
            shareFailed: "Unable to share.", // Shown while facing issue on sharing map.
            ...
            fieldNotConfigured: "Fields are not configured.", // Setting error message when fields of info popup is not configured.
