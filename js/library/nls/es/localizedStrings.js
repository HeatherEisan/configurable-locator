...
define({
    ...
    errorMessages: {
        ...
        shareLoadingFailed: "@es@ Unable to shorten URL, Bit.ly failed to load.", // Shown when unable to create Bit.ly URL.
        shareFailed: "@es@ Unable to share.", // Shown while facing issue on sharing map.
